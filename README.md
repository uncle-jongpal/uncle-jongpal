...
**AI / Computer Vision Engineer**  ·  멀티 에이전트 · 비전 · MLOps

현업에서 AI 코어/비전 엔지니어로 일하며, 모델 경량화부터 LLM 기반 멀티 에이전트 자동화까지 "연구를 실제 동작하는 제품으로" 옮기는 일에 집중합니다.

---

## 🔭 Focus

- **Computer Vision** — 검출/분류 파이프라인, 산불·차선 등 실환경 비전 PoC
- **LLM Agents** — RAG, 멀티 에이전트 오케스트레이션, 음성→에이전트 자동화
- **Model Efficiency** — 양자화·프루닝·증류 등 모델 경량화
- **MLOps** — 실험 추적, 재현 가능한 학습/배포 파이프라인
...
`Python` · `PyTorch` · `OpenCV` · `LangChain` · `FastAPI` · `Next.js` · `Docker` · `PostgreSQL` · `Weights & Biases`
